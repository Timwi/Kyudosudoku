...
namespace KyudosudokuWebsite
{
    sealed class AntiKing : KyuCellConstraint
    {
        ...
        protected override Constraint getConstraint() => new AntiKingConstraint(9, 9, enforcedCells: new[] { Cell });

        public AntiKing(int cell) : base(cell) { }
        private AntiKing() { }    // for Classify

        public override string Svg => $@"<g transform='translate({Kyudosudoku.SudokuX + Cell % 9}, {Kyudosudoku.SudokuY + Cell / 9}) scale(.01)'><path fill='rgba(0, 0, 0, .2)' d='{PathD}' /></g>";
